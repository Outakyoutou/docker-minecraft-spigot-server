...
WORKDIR /plg
COPY plugins/ ./
RUN wget "https://mediafiles.forgecdn.net/files/3697/296/worldedit-bukkit-7.2.10.jar" && wget "https://media.forgecdn.net/files/3461/546/worldguard-bukkit-7.0.6-dist.jar"
